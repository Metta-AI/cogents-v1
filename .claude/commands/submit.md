...
3. Run `uv run pyright` to check for type errors
   - If pyright reports errors, stop and show the failures. Do NOT push broken code. Ask the user how to proceed.
...
6. Build a short summary of what was pushed:
...
7. Post the summary to Discord #cogents using `/announce`:
