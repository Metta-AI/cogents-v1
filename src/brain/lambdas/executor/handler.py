...
def _execute_tool(tool_use: dict, config) -> str:
    ...
    try:
        ...
        elif tool_name == "gmail_check":
            return _tool_gmail_check(tool_input, config)

        elif tool_name == "gmail_send":
            return _tool_gmail_send(tool_input, config)
...
def _tool_gmail_send(tool_input: dict, config) -> str:
